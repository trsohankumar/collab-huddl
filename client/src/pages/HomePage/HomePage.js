  ...
  return (
    <>
      ...
      <div className="branding_info">
        ...
        />
        Meet Huddl, the modern Collab tool
        <br /> Write like a doc, collab and discuss realtime
      </div>
      <div className="room_section">
        ...
        />
        <button onClick={handleJoinRoom} className="gradient-buttons">
          Join Room
        </button>
      </div>
      <div class="custom-shape-divider-bottom-1656563534">
        <svg
          data-name="Layer 1"
